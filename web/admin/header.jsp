	...
	<div class="container">
	    <div class="navbar-header">
	        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                ...
                <a class="navbar-brand" href="index.jsp"><h1 style="color:white;">Admin Panel</h1></a>
	    </div>
	    <!--/.navbar-header-->
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav">
		        ...
		        <li class="dropdown">
		            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Manage staff<b class="caret"></b></a>
		             <ul class="dropdown-menu">
			            ...
			            <li><a href="paginationPageviewstaff.jsp?page=1">View Staff</a></li>
		        ...
		        <li><a href="paginationPage.jsp?page=1">view post</a></li>
