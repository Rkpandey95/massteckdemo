...
<script>
 function validate(){
    ...
    var regPass =/^[7-9][0-9]{9}$/;         
    var name = document.getElementById('emailid').value;
    var namePass = document.getElementById('mobileno').value;
		...
		<div class="col-md-10 offset-md-1" style="margin: 15px">
			<div class="card">
				<div class="card-body">
					...
					<form action="../staffpostjobServlet" method="post">
					...
					<label>Enter Mobile</label>
					  ...
					  <label>Staff ID</label>
                                           <tr>
                                              ...
                                              <%
                                                    Datahelper.openConn();
                                                    ResultSet res =Datahelper.getData("select * from s_register " );
                                                while(res.next())
                                               {%>
				...
				<!--<button class="btn btn-success">Publish Job</button>-->
                                <input type="submit" value="Publish Job" onclick="validate();" name="btnsubmit" />
